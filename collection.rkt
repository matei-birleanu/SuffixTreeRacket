...
(define-syntax-rule (collection-first l) (stream-first l))
(define-syntax-rule (collection-rest l) (stream-rest l))
(define-syntax-rule (collection-map a b) (stream-map a b))
(define-syntax-rule (collection-filter f L) (stream-filter f L))
(define-syntax-rule (collection-empty)  (stream))
(define-syntax-rule (collection-empty? a ) (stream-empty? a))
(define-syntax-rule (collection-reverse b) (stream-reverse b))
(define-syntax-rule (collection-filter-map a b) (stream-filter-map a b))
